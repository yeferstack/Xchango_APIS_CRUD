...
// ReporteController operations for Reporte
...
// Post ...
// @Title Post
// @Description create Reporte
// @Param	body		body 	models.Reporte	true		"body for Reporte content"
// @Success 201 {int} models.Reporte
// @Failure 403 body is empty
// @router / [post]
func (c *ReporteController) Post() {
	var v models.Reporte
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddReporte(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Reporte by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Reporte
// @Failure 403 :id is empty
// @router /:id [get]
func (c *ReporteController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetReporteById(id)
	if err != nil {
...
// @Failure 403
// @router / [get]
func (c *ReporteController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllReporte(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the Reporte
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Reporte	true		"body for Reporte content"
// @Success 200 {object} models.Reporte
// @Failure 403 :id is not int
// @router /:id [put]
func (c *ReporteController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Reporte{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateReporteById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the Reporte
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *ReporteController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteReporte(id); err == nil {
