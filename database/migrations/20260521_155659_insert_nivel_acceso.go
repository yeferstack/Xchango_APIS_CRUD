...
func (m *InsertNivelAcceso_20260521_155659) Up() {
	m.SQL("INSERT INTO sistema.nivel_acceso (nombre, fecha_asignacion) VALUES ('super admin', '2026-05-20 17:14:45.839255');")

}

// Reverse the migrations
func (m *InsertNivelAcceso_20260521_155659) Down() {
	m.SQL("DELETE FROM sistema.nivel_acceso WHERE nombre = 'super admin' ")
