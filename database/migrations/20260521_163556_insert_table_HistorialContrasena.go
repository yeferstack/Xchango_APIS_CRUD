...
func (m *InsertTableHistorialContrasena_20260521_163556) Up() {
	m.SQL("INSERT INTO usuario_seguridad.HistorialContrasena (id_usuario, contrasena_hash, fecha_cambio) VALUES ('1', '$2b$12$OLD1sofia', '2025-01-10 10:00:00')")

}

// Reverse the migrations
func (m *InsertTableHistorialContrasena_20260521_163556) Down() {
	m.SQL("DELETE FROM usuario_seguridad.HistorialContrasena WHERE contrasena_hash='$2b$12$OLD1sofia'") 
