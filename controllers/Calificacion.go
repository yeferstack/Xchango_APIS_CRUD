...
// CalificacionController operations for Calificacion
type CalificacionController struct {
	beego.Controller
}

// URLMapping ...
func (c *CalificacionController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Calificacion
// @Param	body		body 	models.Calificacion	true		"body for Calificacion content"
// @Success 201 {int} models.Calificacion
// @Failure 403 body is empty
// @router / [post]
func (c *CalificacionController) Post() {
	var v models.Calificacion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCalificacion(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Calificacion by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Calificacion
// @Failure 403 :id is empty
// @router /:id [get]
func (c *CalificacionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetCalificacionById(id)
	if err != nil {
...
// @Failure 403
// @router / [get]
func (c *CalificacionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllCalificacion(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the Calificacion
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Calificacion	true		"body for Calificacion content"
// @Success 200 {object} models.Calificacion
// @Failure 403 :id is not int
// @router /:id [put]
func (c *CalificacionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Calificacion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateCalificacionById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the Calificacion
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *CalificacionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteCalificacion(id); err == nil {
