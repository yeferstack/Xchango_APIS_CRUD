...
// BiendigitalController operations for Biendigital
type BiendigitalController struct {
	beego.Controller
}

// URLMapping ...
func (c *BiendigitalController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Biendigital
// @Param	body		body 	models.Biendigital	true		"body for Biendigital content"
// @Success 201 {int} models.Biendigital
// @Failure 403 body is empty
// @router / [post]
func (c *BiendigitalController) Post() {
...
// GetOne ...
// @Title Get One
// @Description get Biendigital by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Biendigital
// @Failure 403 :id is empty
// @router /:id [get]
func (c *BiendigitalController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *BiendigitalController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllBiendigital(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		if l == nil {
...
// Put ...
// @Title Put
// @Description update the Biendigital
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Biendigital	true		"body for Biendigital content"
// @Success 200 {object} models.Biendigital
// @Failure 403 :id is not int
// @router /:id [put]
func (c *BiendigitalController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// Delete ...
// @Title Delete
// @Description delete the Biendigital
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *BiendigitalController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
